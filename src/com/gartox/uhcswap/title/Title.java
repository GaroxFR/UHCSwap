package com.gartox.uhcswap.title;
...
public class Title {
	public void sendTile(Player player, String title, String subtitle, int ticks){
		...
		setTime(player, ticks);
	}
	private void setTime(Player player, int ticks){
